...
* ztna-core/ztna: [v0.26.10 -> v0.26.11](https://ztna-core/ztna/compare/v0.26.10...v0.26.11)
    * [Issue 868](https://ztna-core/ztna/issues/868): `ZITI_EDGE_ROUTER_IP_OVERRIDE` does not override the edge router advertise hostname
    * [Issue 882](https://ztna-core/ztna/issues/882): `ZITI_EDGE_ROUTER_RAWNAME` not stored in quickstart .env file
...
* ztna-core/ztna: [v0.26.9 -> v0.26.10](https://ztna-core/ztna/compare/v0.26.9...v0.26.10)
...
* ztna-core/ztna: [0.26.8 -> 0.26.9](https://ztna-core/ztna/compare/0.26.8...0.26.9)
    * [Issue #845](https://ztna-core/ztna/issues/845) - Setting ZITI_EDGE_ROUTER_IP_OVERRIDE now adds the IP to the CSR SANs of the router config
...
* ztna-core/ztna: [0.26.7 -> 0.26.8](https://ztna-core/ztna/compare/0.26.7...0.26.8)
    * [Issue #835](https://ztna-core/ztna/issues/835) - Ensure model entity tags can be updated via CLI where appropriate
...
* [Issue 823](https://ztna-core/ztna/issues/843): Fixed quickstart bug with architecture detection not supporting `aarch64`
