...
* Maintenance: better logging [sdk-golang#161](https://ztna-core/sdk-golang/pull/161)
  and [edge#700](https://github.com/openziti/edge/pull/700)
* Bug fix: [sdk-golang#162](https://ztna-core/sdk-golang/pull/162) fix race condition on close of ziti
  connections
...
* Bug fix: [ziti#420](https://ztna-core/ztna/issues/420) fix ziti-tunnel failover with multiple interfaces
...
* [ziti#170](https://ztna-core/ztna/issues/170) Fixes the service poll refresh default for ziti-tunnel host
  mode
