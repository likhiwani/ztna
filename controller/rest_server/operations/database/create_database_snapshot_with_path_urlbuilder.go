...
func (o *CreateDatabaseSnapshotWithPathURL) BuildFull(scheme, host string) (*url.URL, error) {
    logtrace.LogWithFunctionName()
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateDatabaseSnapshotWithPathURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateDatabaseSnapshotWithPathURL")
	}
