...
// CreateDatabaseSnapshotWithPathParams contains all the bound params for the create database snapshot with path operation
...
func (o *CreateDatabaseSnapshotWithPathParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body rest_model.DatabaseSnapshotCreate
