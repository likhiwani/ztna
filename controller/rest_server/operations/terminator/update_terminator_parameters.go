...
// UpdateTerminatorParams contains all the bound params for the update terminator operation
...
func (o *UpdateTerminatorParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
