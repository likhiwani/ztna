...
// DetailRouterParams contains all the bound params for the detail router operation
...
func (o *DetailRouterParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
