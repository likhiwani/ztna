...
// UpdateRouterParams contains all the bound params for the update router operation
...
func (o *UpdateRouterParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
