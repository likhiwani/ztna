...
func (o *DeleteLinkURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteLinkURL")
	}
...
func (o *DeleteLinkURL) BuildFull(scheme, host string) (*url.URL, error) {
    logtrace.LogWithFunctionName()
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteLinkURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteLinkURL")
	}
