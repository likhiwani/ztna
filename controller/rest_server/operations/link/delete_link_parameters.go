...
// DeleteLinkParams contains all the bound params for the delete link operation
...
func (o *DeleteLinkParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
