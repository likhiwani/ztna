...
// DetailLinkParams contains all the bound params for the detail link operation
...
func (o *DetailLinkParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
