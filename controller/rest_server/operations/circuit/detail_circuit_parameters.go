...
// DetailCircuitParams contains all the bound params for the detail circuit operation
...
func (o *DetailCircuitParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
